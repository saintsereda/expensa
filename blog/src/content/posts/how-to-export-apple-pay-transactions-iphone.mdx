...
date: 2026-05-10
videoId: "yORq6_XWLRE"
videoTitle: "How to export Apple Pay transactions from iPhone using Shortcuts"
---
...
If you specifically left Mint because of Plaid, this Apple Pay automation plus CSV imports is the full replacement on iPhone — [longer walkthrough here](/blog/how-to-replace-mint-on-iphone-without-plaid). And if you're in a market where Apple Pay only just arrived — like the Philippines, live since August 2026 — the [Philippines-specific guide](/blog/how-to-track-apple-pay-expenses-philippines/) covers supported banks and local caveats.
