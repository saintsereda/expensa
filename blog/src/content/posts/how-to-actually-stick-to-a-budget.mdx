...
In Expensa, this means three categories. That's the whole list. If you'd rather not do the math yourself, the app's Smart Budget Allocation can propose a split for your total based on your country and typical spending patterns — take it, edit it, or ignore it.
