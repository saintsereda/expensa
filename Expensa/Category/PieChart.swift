...
extension Color {
    ...
    static let customChartColors: [Color] = [
        Color(hex: "#E90703"), // Red
        Color(hex: "#FA5607"), // Orange
        Color(hex: "#15FFAB"), // Mint
        Color(hex: "#8E58E0"), // Purple
        Color(hex: "#207DF8"), // Blue
        Color(hex: "#13E0FE"), // Cyan
        Color(hex: "#01CC4A"), // Green
